...
//Author 2 Id: 20230504 section 21,22 Youssef Farid did resize filter and inver color filters
...
int main() {
    cout << "Hello to our program\nThis program you should type the image name and the filter\nour role to apply this filter to image\n";
    char choice;
    while (true) {//loop to make the program dont close
        cout << "A)Grayscale Conversion B)Black and white C)Invert Image D)Flip Image E)Resizing Images F)Exit\nPlease Enter valid choise: ";
